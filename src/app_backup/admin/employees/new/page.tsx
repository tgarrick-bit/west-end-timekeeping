            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="timeApprover" className="block text-sm font-medium text-[#465079] mb-2">
                      Time Approver *
                    </label>
                    <select
                      id="timeApprover"
                      name="timeApprover"
                      value={formData.timeApprover}
                      onChange={handleInputChange}
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#e31c79] focus:border-transparent"
                    >
                      <option value="">Select Time Approver</option>
                      <option value="manager-demo">Jane Doe - Management</option>
                      <option value="manager2-demo">Tom Wilson - Operations</option>
                      <option value="manager3-demo">Lisa Chen - Finance</option>
                    </select>
                  </div>
