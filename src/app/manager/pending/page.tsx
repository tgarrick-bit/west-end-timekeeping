        ...
        <div className={styles.modalOverlay} onClick={() => setShowDetailModal(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalContent}>
              <p><strong>Employee:</strong> {selectedItemDetail.employeeName}</p>
              <p><strong>Email:</strong> {selectedItemDetail.employeeEmail}</p>
              <p><strong>Project:</strong> {selectedItemDetail.projectName}</p>
              <p><strong>Date:</strong> {formatDate(selectedItemDetail.weekEnding)}</p>
              {selectedItemDetail.type === 'timesheet' ? (
                <p><strong>Hours:</strong> {selectedItemDetail.hours}</p>
              ) : (
