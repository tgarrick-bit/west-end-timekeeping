...
export default function TimeByClassReport() {
  ...
  const handleExportToExcel = () => {
    ...
    const fileName = `time_by_class_${startDate}_to_${endDate}.xlsx`
        ...
        <div className="flex gap-6">
          ...
          <div className="w-64 bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="space-y-1">
              ...
              <a href="/admin/reports/time-by-class" className="flex items-center justify-between px-3 py-2 text-sm bg-gray-100 text-gray-900 rounded">
                Time by Class
