...
Check your notification bell and email!`);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#33393c] transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
